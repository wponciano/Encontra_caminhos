...
def identifica_rio(linha, coluna,tamanho_rio = 0):
    ...
    if matrix_original[linha][coluna] == 1:  
        ...
        tamanho_rio = checa_vizinhos(linha,coluna, tamanho_rio)
    return tamanho_rio

def identifica_terra(linha, coluna,tamanho_terra = 0):
    if matrix_original[linha][coluna] == 0:  
        matrix_original[linha][coluna] = 'T' 
        tamanho_terra += 1  
        tamanho_terra = checa_vizinhos_terra(linha,coluna, tamanho_terra)
    return tamanho_terra
    
def checa_vizinhos(linha, coluna, tamanho_atualizado_rio): 
